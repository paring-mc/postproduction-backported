...
public abstract class ConnectedTextureBehaviour2 {

	@Nullable
	public CTSpriteShiftEntry2 getShift(BlockState state, RandomSource rand, Direction direction,
                                       @NotNull TextureAtlasSprite sprite) {
		return getShift(state, direction, sprite);
	}
	
	@Nullable
	public abstract CTSpriteShiftEntry2 getShift(BlockState state, Direction direction,
		@NotNull TextureAtlasSprite sprite);

	// TODO: allow more than one data type per state/face?
	@Nullable
	public abstract CTType2 getDataType(BlockAndTintGetter world, BlockPos pos, BlockState state, Direction direction);
	...
	public static abstract class Base extends ConnectedTextureBehaviour2 {
		@Override
		@Nullable
		public abstract CTSpriteShiftEntry2 getShift(BlockState state, Direction direction,
		...
		@Override
		@Nullable
		public CTType2 getDataType(BlockAndTintGetter world, BlockPos pos, BlockState state, Direction direction) {
			CTSpriteShiftEntry2 shift = getShift(state, direction, null);
			if (shift == null) {
				return null;
			}
