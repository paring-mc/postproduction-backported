...
public class ValueBox2 extends ChasingAABBOutline {
    ...
    protected ValueBoxTransform2 transform;
    ...
    public ValueBox2(Component label, AABB bb, BlockPos pos) {
        this(label, bb, pos, Minecraft.getInstance().level.getBlockState(pos));
    }

    public ValueBox2(Component label, AABB bb, BlockPos pos, BlockState state) {
        super(bb);
        this.label = label;
        this.pos = pos;
    ...
    public ValueBox2 transform(ValueBoxTransform2 transform) {
        this.transform = transform;
        return this;
    }

    public ValueBox2 wideOutline() {
        this.outline = AllIcons.VALUE_BOX_HOVER_6PX;
        return this;
    }

    public ValueBox2 passive(boolean passive) {
        this.isPassive = passive;
        return this;
    }

    public ValueBox2 withColor(int color) {
    ...
    public void render(PoseStack ms, SuperRenderTypeBuffer buffer, Vec3 camera, float pt) {
        ...
        if (transform instanceof ValueBoxTransform2.Sided && params.getHighlightedFace() != null)
            ((ValueBoxTransform2.Sided) transform).fromSide(params.getHighlightedFace());
    ...
    public static class ItemValueBox extends ValueBox2 {
        ItemStack stack;
    ...
    public static class TextValueBox extends ValueBox2 {
        Component text;
    ...
    public static class IconValueBox extends ValueBox2 {
        AllIcons icon;
