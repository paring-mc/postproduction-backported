...
public class ExtraIcons implements ScreenElement {
    public static final ResourceLocation ICON_ATLAS = ResourceLocation.fromNamespaceAndPath(CreateLogisticsBackport.MODID, "textures/gui/icon_atlas.png");
    ...
    private static ExtraIcons next() {
        return new ExtraIcons(++x, y);
    }

    private static ExtraIcons newRow() {
