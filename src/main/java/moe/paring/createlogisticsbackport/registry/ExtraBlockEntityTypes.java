...
import moe.paring.createlogisticsbackport.content.logistics.itemHatch.ItemHatchBlockEntity;
...
import moe.paring.createlogisticsbackport.content.redstone.deskBell.DeskBellBlockEntity;
import moe.paring.createlogisticsbackport.content.redstone.deskBell.DeskBellRenderer;
...
public class ExtraBlockEntityTypes {
    ...
    public static final BlockEntityEntry<ItemHatchBlockEntity> ITEM_HATCH = REGISTRATE
            ...
            .validBlocks(ExtraBlocks.ITEM_HATCH)
    ...
    public static final BlockEntityEntry<PulseTimerBlockEntity> PULSE_TIMER = REGISTRATE
            ...
            .validBlocks(ExtraBlocks.PULSE_TIMER)
    ...
    public static final BlockEntityEntry<DeskBellBlockEntity> DESK_BELL = REGISTRATE
            ...
            .validBlocks(ExtraBlocks.DESK_BELL)
