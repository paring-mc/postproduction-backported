...
public class PackageVisual extends EntityInstance<PackageEntity> implements DynamicInstance {
    ...
    private void animate() {
        ...
        var renderOrigin = materialManager.getOriginCoordinate();
        ...
        var light = EntityVisualExtras.computePackedLight(partialTick, entity, world);
        ...
        instance.loadIdentity()
                ...
                .rotateY(-yaw - 90)
                .unCentre()
                .setBlockLight(light.getFirst())
                .setSkyLight(light.getSecond())
                .markDirty();
    }
