...
public class PackageFilterScreen extends AbstractFilterScreen2<PackageFilterMenu> {
	...
	public void onAddressEdited(String s) {
		...
		ExtraPackets.getChannel()
			.sendToServer(new FilterScreenPacket2(FilterScreenPacket2.Option.UPDATE_ADDRESS, tag));
	}
