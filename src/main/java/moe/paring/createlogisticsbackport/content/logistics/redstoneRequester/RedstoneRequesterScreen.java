...
public class RedstoneRequesterScreen extends AbstractSimiContainerScreen<RedstoneRequesterMenu> {
	...
	protected void init() {
		...
		confirmButton = new NewIconButton(x + bgWidth - 30, y + bgHeight - 25, AllIcons.I_CONFIRM);
		confirmButton.withCallback(() -> minecraft.player.closeContainer());
		addRenderableWidget(confirmButton);

		allowPartial = new NewIconButton(x + 12, y + bgHeight - 25, ExtraIcons.I_PARTIAL_REQUESTS);
		...
		dontAllowPartial = new NewIconButton(x + 12 + 18, y + bgHeight - 25, ExtraIcons.I_FULL_REQUESTS);
